...
<xsl:stylesheet version="3.0"
    ...
    <xsl:template name="add-header-nodes">
        ...
        <xsl:call-template name="add-field-node">
            <xsl:with-param name="field"><path>/Q{urn:isbn:1-931666-22-9}ead/Q{urn:isbn:1-931666-22-9}eadheader/Q{urn:isbn:1-931666-22-9}profiledesc/Q{urn:isbn:1-931666-22-9}creation/Q{urn:isbn:1-931666-22-9}date</path></xsl:with-param>
    ...
    <xsl:template name="add-archdesc-nodes">
        ...
        <xsl:call-template name="add-big-field-node">
            <xsl:with-param name="field"><path>/Q{urn:isbn:1-931666-22-9}ead/Q{urn:isbn:1-931666-22-9}archdesc/Q{urn:isbn:1-931666-22-9}acqinfo/Q{urn:isbn:1-931666-22-9}p</path></xsl:with-param>
        </xsl:call-template>
        <xsl:call-template name="add-big-field-node">
            <xsl:with-param name="field"><path>/Q{urn:isbn:1-931666-22-9}ead/Q{urn:isbn:1-931666-22-9}archdesc/Q{urn:isbn:1-931666-22-9}scopecontent/Q{urn:isbn:1-931666-22-9}p</path></xsl:with-param>
        </xsl:call-template>
        <xsl:call-template name="add-big-field-node">
            <xsl:with-param name="field"><path>/Q{urn:isbn:1-931666-22-9}ead/Q{urn:isbn:1-931666-22-9}archdesc/Q{urn:isbn:1-931666-22-9}appraisal/Q{urn:isbn:1-931666-22-9}p</path></xsl:with-param>
        </xsl:call-template>
        <xsl:call-template name="add-big-field-node">
            <xsl:with-param name="field"><path>/Q{urn:isbn:1-931666-22-9}ead/Q{urn:isbn:1-931666-22-9}archdesc/Q{urn:isbn:1-931666-22-9}accruals/Q{urn:isbn:1-931666-22-9}p</path></xsl:with-param>
        </xsl:call-template>
        <xsl:call-template name="add-big-field-node">
            <xsl:with-param name="field"><path>/Q{urn:isbn:1-931666-22-9}ead/Q{urn:isbn:1-931666-22-9}archdesc/Q{urn:isbn:1-931666-22-9}arrangement/Q{urn:isbn:1-931666-22-9}p</path></xsl:with-param>
        </xsl:call-template>
        <xsl:call-template name="add-big-field-node">
            <xsl:with-param name="field"><path>/Q{urn:isbn:1-931666-22-9}ead/Q{urn:isbn:1-931666-22-9}archdesc/Q{urn:isbn:1-931666-22-9}accessrestrict/Q{urn:isbn:1-931666-22-9}p</path></xsl:with-param>
        </xsl:call-template>
        <xsl:call-template name="add-big-field-node">
            <xsl:with-param name="field"><path>/Q{urn:isbn:1-931666-22-9}ead/Q{urn:isbn:1-931666-22-9}archdesc/Q{urn:isbn:1-931666-22-9}userestrict/Q{urn:isbn:1-931666-22-9}p</path></xsl:with-param>
        </xsl:call-template>
        <xsl:call-template name="add-big-field-node">
            <xsl:with-param name="field"><path>/Q{urn:isbn:1-931666-22-9}ead/Q{urn:isbn:1-931666-22-9}archdesc/Q{urn:isbn:1-931666-22-9}phystech/Q{urn:isbn:1-931666-22-9}p</path></xsl:with-param>
        </xsl:call-template>
        <xsl:call-template name="add-big-field-node">
            <xsl:with-param name="field"><path>/Q{urn:isbn:1-931666-22-9}ead/Q{urn:isbn:1-931666-22-9}archdesc/Q{urn:isbn:1-931666-22-9}otherfindaid/Q{urn:isbn:1-931666-22-9}p</path></xsl:with-param>
        </xsl:call-template>
        <xsl:call-template name="add-big-field-node">
            <xsl:with-param name="field"><path>/Q{urn:isbn:1-931666-22-9}ead/Q{urn:isbn:1-931666-22-9}archdesc/Q{urn:isbn:1-931666-22-9}originalsloc/Q{urn:isbn:1-931666-22-9}p</path></xsl:with-param>
        </xsl:call-template>
        <xsl:call-template name="add-big-field-node">
            <xsl:with-param name="field"><path>/Q{urn:isbn:1-931666-22-9}ead/Q{urn:isbn:1-931666-22-9}archdesc/Q{urn:isbn:1-931666-22-9}altformavail/Q{urn:isbn:1-931666-22-9}p</path></xsl:with-param>
        </xsl:call-template>
        <xsl:call-template name="add-big-field-node">
            <xsl:with-param name="field"><path>/Q{urn:isbn:1-931666-22-9}ead/Q{urn:isbn:1-931666-22-9}archdesc/Q{urn:isbn:1-931666-22-9}relatedmaterial/Q{urn:isbn:1-931666-22-9}p</path></xsl:with-param>
        </xsl:call-template>
        <xsl:call-template name="add-big-field-node">
    ...
    <xsl:template name="add-archdesc-did">
        ...
        <xsl:call-template name="add-field-node">
            <xsl:with-param name="field"><path>/Q{urn:isbn:1-931666-22-9}ead/Q{urn:isbn:1-931666-22-9}archdesc/Q{urn:isbn:1-931666-22-9}did/Q{urn:isbn:1-931666-22-9}physdesc</path></xsl:with-param>
        </xsl:call-template>
        <xsl:call-template name="add-field-node">
